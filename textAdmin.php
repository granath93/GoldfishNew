<!--
DENNA FIL ÄR "TEXT"-SIDAN I ADMIN-DELEN DÄR ADMIN REDIGERAR ALL TEXT SOM SKALL VISAS PÅ FRONT-END, WEBBSIDAN UTÅT MOT BESÖKARNA
-->
...
include("includes/headAdmin.php"); 
	...
	//Variabler som hålls tomma för att senare kunna fyllas och skrivas ut
	$feedback="";
	$empty="";
	$arrow="";
...
<?php
		...
		$arrow="arrow-right";
			...
			//Om användaren ångrar att han raderade all text ångras rensningen
				...
				<!-- Här börjar sektionen för välkomsttext -->
				<h1>Välkomsttext</h1>
...
<?php }
			...
			<!-- Här börjar sektionen för tävlingsregler -->
